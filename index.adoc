...
Some boards, like the Adafruit Feather RP2040, have higher capacitance on the crystal oscillator and need to set a longer `XOSC_Startup_Delay` to compensate.
